...
const FormDessert = ({ selectedDessert, fetchRequest }) => {
  ...
  return (
    <Box
      className="form"
      onSubmit={(e) => fetchRequest(e, params)}
      component="form"
      noValidate
      autoComplete="off"
    >
      <div>
        ...
        <FormGroup id="formBasicRegime">
          ...
          <FormControlLabel
            control={
              <Checkbox
                checked={params.regimes.includes("vegan")}
                onChange={handleCheckBox}
              />
            }
            label="Vegan"
          ...
          <FormControlLabel
            control={
              <Checkbox
                checked={params.regimes.includes("gluten free")}
                onChange={handleCheckBox}
              />
            }
            label="Gluten Free"
